...
public class FriendController {
    ...
    public ResponseEntity<String> sendFriendRequest(@RequestParam("friendEmail") String friendEmail){
    ...
    public ResponseEntity<String> denyFriendRequest(@RequestParam("friendId") Long friendId){
