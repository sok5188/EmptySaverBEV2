...
class MemberTeamRepositoryTest {
    ...
    public void 그룹에멤버추가(){
        ...
        mt.addMemberToTeam(member,team,member);
        em.persist(mt);

        MemberTeam mt2=new MemberTeam();
        mt2.addMemberToTeam(member2,team,member);
        em.persist(mt2);
    ...
    public void 쿼리테스트(){
        ...
        mt3.addMemberToTeam(member,team2,member2);
        em.persist(mt3);
        MemberTeam mt4=new MemberTeam();
        mt4.addMemberToTeam(member2,team2,member2);
        em.persist(mt4);
